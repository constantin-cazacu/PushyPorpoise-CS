...
root = Tk()
root.title('Lab Work No. 4 - Constantin Cazacu')
...
def open_file():
    ...
    if extension == 'audit':
        ...
        custom_item['AUDIT_POLICY_SUBCATEGORY'] = {'type': [], 'description': [], 'value_type': [], 'value_data': [],
                                                   'check_type': [], 'audit_policy_policy': []}
        ...
        custom_item['AUDIT_IIS_APPCMD'] = {'type': [], 'description': [], 'value_type': [], 'value_data': [],
                                           ...
                                           'appcmd_filler_value': []}
        custom_item['AUDIT_ALLOWED_OPEN_PORTS'] = {'type': [], 'description': [], 'value_type': [], 'value_data': [],
                                                   'port_type': []}
        ...
        custom_item['FILE_CONTENT_CHECK_NOT'] = {'type': [], 'description': [], 'value_type': [], 'value_data': [],
                                                 'check_type': [], 'regex': [], 'expect': [], 'file_option': []}
        custom_item['REG_CHECK'] = {'type': [], 'description': [], 'value_type': [], 'value_data': [], 'reg_key': [],
                                    'reg_item': [], 'key_item': []}
...
def save_as_file():
    ...
    checkbox_txt = Text(root_checkbox, width=80, height=20, yscrollcommand=checkbox_scroll.set)
...
def rollback_audits():
    ...
    # my_text.insert(END, 'DONE! Rollback Complete!')
    # cmd = 'reg import ' + 'Backup.reg'
    # output = os.popen(cmd).read()
